...
<body>
        				...
        				try{
        					...
        					Statement statement=connection.createStatement();
        					 ResultSet rs = statement.executeQuery("select  * from product;");
        						 ...
        						 while (rs.next()) {
        		                        out.println("<tr>");
        		                        out.println("<td>" + rs.getString("pr_id") + "</td>");
        		                        out.println("<td>" + rs.getString("pr_name") + "</td>");
        		                        out.println("<td>" + rs.getString("batch_num") + "</td>");
	...
	function addRow() {
        ...
        window.location.href = "addnewproduct.jsp"; 
    }
	</script>
</html>