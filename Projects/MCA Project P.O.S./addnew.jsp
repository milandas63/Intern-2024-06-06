...
function save() {
    ...
    var sql = "insert into manufacture(mfr_id,mfr_name,mfr_abbr,headoffice,contact,pin) values";
	...
	str+=sql;
	alert(str);
    window.location.href='./manufacturesubmit.jsp?sql='+str;
}

function exit() {
    alert("If you are Exit This Page then  clicked ok");
    window.location.href = 'manufacture.jsp';
}
